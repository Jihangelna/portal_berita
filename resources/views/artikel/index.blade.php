                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="{{ url('artikel/'.$row->id.'/edit') }}" class="btn btn-outline-dark btn-sm mr-1"><i class="bi bi-pencil-fill"></i></a>
                                    <a href="{{ url('artikel/hapus/'. $row->id) }}" class="btn btn-outline-dark btn-sm"><i class="bi bi-trash-fill"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
